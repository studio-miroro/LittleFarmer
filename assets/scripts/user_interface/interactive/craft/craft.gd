...
@onready var container:GridContainer = get_node("/root/" + main_scene + "/UI/Windows/Crafting/Panel/HBoxContainer/Items/GridContainer")
@onready var build_button:Button = get_node("/root/" + main_scene + "/UI/Windows/Crafting/Panel/HBoxContainer/Info/VBoxContainer/Button/Craft")

@onready var blueprint:PackedScene = load("res://assets/nodes/user_interface/craft/blueprint.tscn")

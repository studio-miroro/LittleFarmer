...
@onready var balance:Control = get_node("/root/" + main_scene + "/UI/Hud/Main/Indicators/Balance")
...
@onready var button_script:Button = get_node("/root/" + main_scene + "/UI/Windows/Mailbox/Panel/HBoxContainer/ContentScroll/VBoxContainer/Items/VBoxContainer/ButtonContainer/GetItems")
